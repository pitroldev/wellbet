 ...
 * recorte). Secundário = contorno de fio duro 2px.
 */
export function CTA({
  href,
  children,
  ...
  return (
    <a
      href={href}
      className={cn(
        "group inline-flex items-center justify-center gap-2 bg-magenta px-7 py-3.5 font-[family-name:var(--font-geist-mono)] text-sm font-bold uppercase tracking-[0.08em] text-ink transition-transform duration-200 hover:-translate-x-0.5 hover:-translate-y-0.5",
        className,
      )}
      style={{
        clipPath: "var(--stub)",
