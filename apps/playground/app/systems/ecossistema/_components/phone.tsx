...
/** Moldura de celular do ecossistema — campo indigo, proporção iPhone (~9/19.5). */
  ...
  return (
    <div className="flex shrink-0 flex-col items-center gap-3">
      <div
        ...
        style={{
          aspectRatio: "9 / 19.5",
          background: E.fieldDeep,
          border: `9px solid #0B0530`,
          boxShadow: "0 30px 60px -28px rgba(8,4,40,.85)",
        }}
      >
        {/* dynamic island */}
      ...
      {label && (
        <span className="text-xs font-bold uppercase tracking-widest" style={{ color: E.peri, opacity: 0.7 }}>
          {label}
        </span>
      )}
    </div>
